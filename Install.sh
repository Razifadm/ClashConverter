...
https://raw.githubusercontent.com/Razifadm/ClashConverter/OC/usr/lib/lua/luci/controller/clash_converter.lua >/dev/null 2>&1

# Download view
wget -O /usr/lib/lua/luci/view/clash_converter/index.htm \
https://raw.githubusercontent.com/Razifadm/ClashConverter/OC/usr/lib/lua/luci/view/clash_converter/index.htm >/dev/null 2>&1
